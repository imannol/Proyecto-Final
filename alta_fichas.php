            ...
            <div class="container">
              <form accept-charset="utf-8" action="" method="POST">
               ...
               <div class="form-group col-6" >
                <label for="Fecha">Fecha en que se dejaran las fichas para su venta.</label>
                <input type="date" class="form-control" id="fecha" aria-describedby="fecha" placeholder="fecha" name="fecha" required>
                <small id="fecha" class="form-text text-muted">Ingresé la fecha del día en que se entregaran las fichas.</small></div>
                

                <div class="form-group col-6" >
                  <label for="Fechaa">Fecha en la cual se recogeran las fichas.</label>
                  <input type="date" class="form-control" id="fechaa" aria-describedby="fechaa" placeholder="2018-12-12" name="fechaa" required>
                  <small class="form-text text-muted">Ingresé la fecha para el día en que se recogeran las fichas. </small></div>
                  <!--/Div-->
                  ...
                  <div class="form-group col-md-6">
                    <label for="Estado del servicio">Estado del servicio de las fichas.</label>
                    <select name="hoi" id="hoi"  class="form-control" required>
                     <option >Seleccione...</option>
                     <option>Fichas habilitadas</option>
                     <option  >Fichas fuera de servicio</option>
                     ?>
                   </select>
                 </div>
                 <!--/Div-->
                 ...
                 <div class="form-group col-6" >
                  ...
                  <input type="text" class="form-control" id="obs" aria-describedby="obs" placeholder="" name="obs" required>
                  <small class="form-text text-muted"> Posibles fallas en el sistema por lo cual las fichas no se vendieron. </small></div>
                  <!--/Div-->
                  <!--/Div-->
...
// verificamos la conexion de la base de datos
 ...
 //numero el cual recibe la condicion
  ...
  //la estructura de la consulta, los datos deven ser los mismos de la base de datos y a las bariables   
                  $insertar = "INSERT INTO fichaje (id,fecha_entregar,fecha_recoger,estado_servicio,observaciones) VALUES
                  ('".$id."','".$fecha."','".$fechaa."','".$eds."','".$obs."')";
   ...
   //metodo para insertar los registros
     ...
     //encaso de que la accion sea pocitiva tomara esta condicion * u *
                   ...
                   window.location='alta_fichas.php';
                   </script>
                   </body>
                   </html>
                   ";
                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th scope="col">Fecha en que se entregaron las fichas.</th>
                              <th scope="col">Fecha en que se recogeran las fichas.</th>
                              <th scope="col">Estado del servicio de las fichas.</th>
                          ...
                          <tbody>
                            ...
                            while($array=mysqli_fetch_array($query)){
                              ...
                              echo "<td><a href='actualizar_fichas.php?id=$array[0]'><button type='button' class='btn btn-warning'><i class='fas fa-edit'></i></button></td>";

                              echo "<td><a href='borrar_fichas.php?id=$array[0]'><button type='button' class='btn btn-danger'><i class='fas fa-trash'></i></button></td>";
                              echo "</tr>";
                            }
