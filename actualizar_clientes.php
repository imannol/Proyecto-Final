            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a class="nav-link" href="alta_monto_fichas.php"><i class="fas fa-wrench"><font color="black" size="3"> Cobranza.</i></font></a>
                </li>
...
<!-- VALIDAR FORMULARIO OJO -->
      ...
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-4"><font face="Arial Black" size="18"> Actualizar clientes.</font></h1>
        </div>
      </div>
      ...
      $ressql=mysqli_query($mysqli,"SELECT id_cliente,nombre_cliente,Apodo,telefono,domicilio,ipe,instal,id_localidad from cliente where id_cliente = $id" );
     ...
     <!--AQUI COMIENZA EL NOMBRE DEL CLIENTE -->
     <div class="container">
      <form  name="frm_registro" accept-charset="utf-8" action="validar_actualizar.php" method="POST" onsubmit="return validacion()">
       <!--Div-->
       
       <input type="hidden" class="form-control" id="id" aria-describedby="id" name="id" placeholder="Luis Imannol" name="id" value= "<?php echo $i ?>" required>
       
       <div class="form-group col-6" >
        <label for="nombre">Nombre.</label>
        <input type="text" maxlength="45" class="form-control" id="nombre" aria-describedby="nombre" placeholder="Luis Imannol" name="nombre" value= "<?php echo $n ?>" required>
        ...
        <div class="form-group col-6" >
          ...
          <input type="text" maxlength="45" class="form-control" id="apodo" aria-describedby="apodo" placeholder="Sicario" name="apodo" value= "<?php echo $a ?>" required>
          <small id="apodo" class="form-text text-muted">Escriba el 'Apodo' del cliente.</small></div>
          <!--/Div-->
          ...
          <div class="form-group col-6" >
            ...
            <input type="text" class="form-control" id="telefono" aria-describedby="telefono" onkeypress="return check(event)" placeholder="3251009246"  maxlength="10"  name="telefono" value= "<?php echo $t ?>" required>
            ...
            <div class="form-group col-6" >
              ...
              <input type="text" class="form-control" id="domicilio" aria-describedby="domicilio" maxlength="45" placeholder="Guerrero y Campeche" name="domicilio" value= "<?php echo $d ?>" required>
              ...
              <div class="form-group col-6" >
                ...
                <input type="text" class="form-control" id="ip" aria-describedby="ip" placeholder="192.168.0.1" maxlength="15"  name="ip" value= "<?php echo $pei ?>">
              ...
              <div class="form-group col-6" >
                <label for="Dia">Fecha de Instalacion. </label>
                <input type="date" class="form-control" id="dia" aria-describedby="dia" placeholder="2019/04/01" maxlength="15"  name="dia" value= "<?php echo $dia ?>">
                <small id="ip" class="form-text text-muted">Escriba la fecha de instalacion.</small></div>
                ...
                <div class="form-group col-md-6">
                 ...
                 <select name="localidad" value= "<?php echo $l ?>"  id=""  class="form-control" required>
                   ...
                   {
                     if($arreglo['id_localidad'] == $arreglo['id_localidad']){
                      echo '<option value="'.$arreglo["id_localidad"].'"selected="select">'.$arreglo['nombre_localidad'].'</option>';
                    }else{
