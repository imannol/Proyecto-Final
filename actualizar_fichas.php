...
if(cmbSelector == null || cmbSelector == 0){
  ...
  <body>
    ...
    $ressql=mysqli_query($mysqli,"SELECT * FROM fichaje WHERE id=$id" );
...
<div class="jumbotron">
        <div class="container">
        <h1 class="display-4"><font face="Arial Black" size="18">Actualizar fichas.</font></h1>

        </div>
      </div>
      <!--AQUI COMIENZA EL NOMBRE DEL CLIENTE -->
      <div class="container">
        <form accept-charset="utf-8" action="validar_fichas.php" method="POST">
                 
                 <input type="hidden" class="form-control" id="id" aria-describedby="id" value= "<?php echo $aidi ?>" placeholder="id" name="id" required>

          <div class="form-group col-6" >
            <label for="Fecha">Fecha en que se dejaran las fichas para su venta.</label>
            <input type="date" class="form-control" id="fecha" aria-describedby="fecha" value= "<?php echo $fecha?>"  placeholder="2018-12-12" name="fecha" required>
            <small id="fecha" class="form-text text-muted">Ingresé la fecha del día en que se recogeran las fichas.</small></div>
            
          <div class="form-group col-6" >
            <label for="Fechaa">Fecha en la cual se recogeran las fichas.</label>
            <input type="date" class="form-control" id="fechaa" aria-describedby="fechaa" value= "<?php echo $fechaa?>" placeholder="2018-12-12" name="fechaa" required>
        ...
        <label for="hoi">Estado del servicio de las fichas.</label>
       ...
       <option >Seleccione...</option>
         <option >Fichas habilitadas</option>
           <option>Fichas fuera de servicio</option>
            ...
            <input type="text" class="form-control" id="obs" aria-describedby="obs" value= "<?php echo $obs?>" placeholder="" name="obs" required>
