...
<html>
<head>
  <title>Actualizar monto de fichas.</title>
  <meta charset="utf-8">
    ...
    <body>
     ...
     <div class="wrapper">
      ...
      <div class="content">
        ...
        $ressql=mysqli_query($mysqli,"SELECT * FROM dinero WHERE id_monto =$id" );
        ...
        <div class="container">
          <div class="jumbotron">
            <div class="container">
              <h1 class="display-4"><font face="Arial Black" size="18">Actualizar monto fichas.</font></h1>

            </div>
          </div>
          <!--AQUI COMIENZA EL NOMBRE DEL CLIENTE -->
          <div class="container">
            <form accept-charset="utf-8" action="validar_monto_fichas.php" method="POST">
             
             <input type="hidden" class="form-control" id="id" aria-describedby="id" value= "<?php echo $id ?>" placeholder="id" name="id" required>
             
             <!--AQUI COMIENZA EL APODO DEL CLIENTE -->
             <!--Div-->
             <div class="form-group col-6" >
              <label for="fichas">* Fichas que se entregaron en las tiendas.</label>
              <input type="number" value= "<?php echo $fichas?>" class="form-control" id="f" aria-describedby="f" placeholder="fichas" name="fichas" required>
              <small id="fichas" class="form-text text-muted">Ingresé sus fichas por favor.</small></div>

               <div class="form-group col-6" >
                <label for="Precio">* Ingresé el costo de las fichas.</label>
                <input type="number" class="form-control" id="precio" aria-describedby="precio" value= "<?php echo $precio ?>" placeholder="precio" name="precio" required>
                <small id="precio" class="form-text text-muted">Ingresé el costo por ficha.</small></div>
                 ...
                 <select name="localidad"
                  value= "<?php echo $localidad ?>" class="form-control" required>
